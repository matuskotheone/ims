...
#define __SIMLIB__        0x0309 // version of SIMLIB (numerical)
#define SIMLIB_VERSION    "3.09" // version of SIMLIB (string)

#define SIMLIB_COPYRIGHT  "(c) Petr Peringer, 1991-2022"
// -------------------------------------------------------------------------
...
#else
# warning  "SIMLIB is not tested on this system/compiler"
#endif
...
//! during execution by e.g. Wait method call (it is a coroutine)
//! \ingroup simlib
